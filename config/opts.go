...
type (
	Opts struct {
		...
		Repair struct {
			...
			AzureVmssAction      string        `long:"repair.azure.vmss.action"        env:"REPAIR_AZURE_VMSS_ACTION"        description:"Defines the action which should be tried to repair the node (VMSS)" default:"redeploy" choice:"restart"  choice:"redeploy" choice:"reimage"`                                             //nolint:staticcheck
		...
		Update struct {
			...
			AzureVmssAction       string        `long:"update.azure.vmss.action"        env:"UPDATE_AZURE_VMSS_ACTION"        description:"Defines the action which should be tried to update the node (VMSS)" default:"update+reimage" choice:"update" choice:"update+reimage"`                                                    //nolint:staticcheck
